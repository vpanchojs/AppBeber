...
//    private OnFragmentInteractionListener mListener;
    ...
    public static DialogMessageFragment newInstance(String message, String title, String btnPos, String btnCancel) {
        DialogMessageFragment fragment = new DialogMessageFragment();
        Bundle args = new Bundle();
        args.putString("message", message);
        args.putString("title", title);
    ...
    public static DialogMessageFragment newInstance(String message, String title, boolean buttonPossitive, String nameButtonPossitive, String nameButtonNegative) {
        DialogMessageFragment fragment = new DialogMessageFragment();
        Bundle args = new Bundle();
        args.putString("message", message);
        args.putString("title", title);
